...
firebase= firebase.FirebaseApplication("https://scad-76dee-default-rtdb.firebaseio.com/",None)

cred = credentials.Certificate("scad-76dee-firebase-adminsdk-8l7fd-6c7e1e3838.json")
...
if __name__ == "__main__":
    ...
    while cap:
            ...
            #cv2.line(frame,(1000,100),(1000,800),(0,255,0),2)
            ...
            if cont != personas:
                if tol:
                    ...
                    if tolerancia == 5:
                        ...
                        personas = cont
                        tolerancia = 0
                        #Aqui mandar se;al a DB variable salidas
                        #
                        #print("holaaaaa")
                        firebase.put('/tipo_pasaje/1001/','salidas',salidas)
